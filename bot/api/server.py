...
async def update_reminders(req: UpdateReminderRequest):
...
async def get_stats(telegram_id: int):
    stats = await db.get_stats(telegram_id)
    return stats
...
async def reset_user_data_endpoint(req: ResetDataRequest):
